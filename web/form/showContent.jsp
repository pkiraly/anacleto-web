...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="cssLink.do?name=<bean:write name="showDocumentForm" property="book" filter="false" />.css">
...
var tries = 0;
var name = '<bean:write name="showDocumentForm" property="name" />';
